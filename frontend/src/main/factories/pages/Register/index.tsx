    ...
    <>
      <div
           ...
           <Modal
            ...
            >X</button>
               <div className={styles.status}>
                  <h2 className={styles.titleModal}>Registrando Imovel na Blockchain Celo...</h2>
        ...
        {isMinted && (
         ...
         >
          <button onClick={() => setmodalIsOpen(!modalIsOpen)} className={styles.closeModaSucess}>X</button>
          <div className={styles.action}>
          <h2 className={styles.titleModal}>Imovel Registrado com Sucesso!</h2>
            <div className={styles.imageContainer}>
                <img className={styles.sucessgif} src="/public/sucess.gif" alt="" />
            </div>
            <div className={styles.paragraphContainer}>
              ...
              <p className={styles.paragraphModal}>
                O hash da transação é: <a  href={`https://explorer.celo.org/alfajores/tx/${transationHash}`}>
                {transationHash}
                </a>
              </p>
          </div>
